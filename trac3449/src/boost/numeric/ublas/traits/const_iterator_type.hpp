...
{
	typedef typename MatrixT::const_iterator1 type;
};
...
{
	typedef typename MatrixT::const_iterator2 type;
};
...
{
	typedef typename VectorT::const_iterator type;
};
...
{
	typedef typename detail::const_iterator_type_impl<MatrixT,tag::minor,typename MatrixT::orientation_category>::type type;
};
