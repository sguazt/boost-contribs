...
{
	typedef typename MatrixT::iterator1 type;
};
...
{
	typedef typename MatrixT::iterator2 type;
};
...
{
	typedef typename detail::iterator_type_impl<MatrixT,tag::major,typename MatrixT::orientation_category>::type type;
};
...
{
	typedef typename detail::iterator_type_impl<MatrixT,tag::minor,typename MatrixT::orientation_category>::type type;
};
